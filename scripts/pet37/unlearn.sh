...
# 18.4
# python main_mu.py --dataset pet-37 --model resnet18 --forget_ratio 0.5 --alpha 1 --unlearn_lr 3e-2 --uni_name FT --num_epochs 4  --batch_size 32
# 33.6
...
# 33.2
python main_mu.py --dataset pet-37 --model resnet18 --forget_ratio 0.5 --alpha 1 --unlearn_lr 54e-5 --uni_name RL --num_epochs 10  --batch_size 32
# 22.4
...
# 19.6
python main_mu.py --dataset pet-37 --model resnet18 --forget_ratio 0.5 --alpha 0.1 --unlearn_lr 5e-3 --uni_name GA_l1 --num_epochs 10 --batch_size 32
# 30.4
python main_mu.py --dataset pet-37 --model resnet18 --forget_ratio 0.5 --alpha 1 --unlearn_lr 12e-5 --uni_name UNSC --num_epochs 20 --batch_size 64
