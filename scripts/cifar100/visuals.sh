...
# fisher
python result_analysis/visual_results.py --dataset cifar-100 --model efficientnet_s --forget_ratio 0.5 --uni_name fisher --model_suffix restore --batch_size 256 --fig_title Fisher
python result_analysis/visual_results.py --dataset cifar-100 --model efficientnet_s --forget_ratio 0.5 --uni_name fisher --model_suffix student_only --batch_size 256 --fig_title Fisher
# GA_l1
