...
# python nets/mria.py --dataset flower-102 --model swin_t --st_model resnet18 --forget_ratio 0.5 --uni_name FT --num_epochs 1 --align_epochs 0 --distill_epochs 10 --learning_rate 1e-4  --lr_student 2e-4 --no_t_update --batch_size 32
# FT_l1
...
# python nets/mria.py --dataset flower-102 --model swin_t --st_model resnet18 --forget_ratio 0.5 --uni_name UNSC --num_epochs 1 --align_epochs 0 --distill_epochs 10 --learning_rate 1e-4  --lr_student 2e-4 --no_t_update --batch_size 32
